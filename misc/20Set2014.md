...
<pre>
    ...
    :public key <a href="#packet" title="packet">packet</a>:
        <a href="#packet_version" title="packet_version">version 4</a>, <a href="#key_algo" title="key_algo">algo 1</a>, created <a href="#primary_key" title="Primary key">1281838967</a>, expires 0
        pkey[0]: [4096 bits]
        pkey[1]: [17 bits]
        <a href="#primary_key" title="Primary key">keyid: 8A3171EF366150CE</a>

    # <a href="#primary_key" title="Primary key">User ID #1</a>
    :user ID packet: “David Steele <daves@users.sourceforge.net>”

    # <a href="#primary_key" title="Primary key">Endorsing Signatures</a>
    # <a href="#primary_key" title="Primary key">Self Signature</a>
    :signature packet: algo 1, keyid 8A3171EF366150CE
        version 4, created 1281838967, md5len 0, <a href="#primary_key" title="Primary key">sigclass 0x13</a>
        <a href="#primary_key" title="Primary key">digest algo 8</a>, begin of digest f9 34
        <a href="#primary_key" title="Primary key">hashed subpkt</a> 2 len 4 (sig created 2010-08-15)
        hashed subpkt 27 len 1 (<a href="#primary_key" title="Primary key">key flags</a>: 03)
        hashed subpkt 11 len 4 (<a href="#primary_key" title="Primary key">pref-sym-algos</a>: 9 8 7 3)
        hashed subpkt 21 len 4 (<a href="#primary_key" title="Primary key">pref-hash-algos</a>: 10 9 8 11)
        hashed subpkt 22 len 4 (pref-zip-algos: 2 3 1 0)
        hashed subpkt 30 len 1 (<a href="#primary_key" title="Primary key">features</a>: 01)
        hashed subpkt 23 len 1 (<a href="#primary_key" title="Primary key">key server preferences</a>: 80)
        subpkt 16 len 8 (issuer key ID 8A3171EF366150CE)
        data: [4092 bits]
    # <a href="#primary_key" title="Primary key">External Signatures</a>
    ...
    # <a href="#primary_key" title="Primary key">Encryption subkey<</a>
    ...
    # <a href="#primary_key" title="Primary key">Signing subkey</a>
    :public sub key packet:
